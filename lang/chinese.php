...
$_LANG['affiliatesintrotext'] = "现在激活您的推介账号：";
...
$_LANG['carttitle'] = "购物车";
$_LANG['changessavedsuccessfully'] = "修改保存成功！";
...
$_LANG['clientareaaddress2'] = "地址（第二行，选填）";
...
$_LANG['clientareacompanyname'] = "公司名称（个人可不填）";
...
$_LANG['clientareaerrorlastname'] = "您没有输入姓氏";
...
$_LANG['downloadsintrotext'] = "下载库中包含很多您在使用过程中可能用到的说明、演示、程序、视频等其他文件。";
...
$_LANG['invoicesbacktoclientarea'] = "&laquo; 返回用户中心";
...
$_LANG['newsletterunsubscribe'] = "退订营销邮件";
$_LANG['emailoptoutdesc'] = "勾选此项退订我们给您发送的营销邮件";
...
$_LANG['twofaactivationcomplete'] = "两步验证设置完成！";
...
$_LANG['orderForm']['streetAddress2'] = "联系地址（第二行，选填）";
